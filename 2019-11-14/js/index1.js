...
var bigbox = document.querySelector(".phone-list");
var html = "";

// of  直接可以那个对象
// in 是拿到数值的下表 arryData[index]
for (var phone of arryData) {
    // var phone = arryData[key];
    ...
    <h3><a href="" class="title">${phone.title}</a></h3>
    <p class="desc">${phone.desc}</p>
    <p class="price"><span>${phone.price}</span>元</p>
    </section>`
    html += section;
}
